import svgPaths from "./svg-40581cha8d";
    ...
    <div className="h-[66px] min-h-[44px] relative shrink-0 w-[113px]" data-name="Button">
      <div className="absolute inset-[-18.18%_-21.24%_-54.55%_-21.24%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 161 114">
          <g filter="url(#filter0_d_13_32)" id="Button">
          ...
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="114" id="filter0_d_13_32" width="161" x="0" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_13_32" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_13_32" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
